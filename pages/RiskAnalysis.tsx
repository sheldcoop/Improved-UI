...
import { Play, TrendingDown, Activity, AlertTriangle, Shuffle } from 'lucide-react';
...
const RiskAnalysis: React.FC = () => {
    ...
    return (
        <div className="space-y-6">
            ...
            {fromBacktest && (
                <div className="flex items-center gap-2 bg-indigo-900/20 border border-indigo-700/40 rounded-lg px-4 py-2 text-sm text-indigo-300">
